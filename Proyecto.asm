data SEGMENT
    menu db 0Ah, 0Dh, 'ELIGE UNA OPCION: 1.-COMPARACION DE NUMEROS 2.-OPERACIONES ARITMETICAS CON 2 DIGITOS 3.-IMAGENES 4.-SALIR: $'
    menu1 db 0Ah, 0Dh, 'ELIGE UNA OPCION: 1.-COMPARACION DE 2 NUMEROS 2.-NUMERO MAYOR DE 5 NUMEROS 3.-SALIR: $'
    ...
    msj6 db 0Ah, 0Dh,'INGRESA EL PRIMER NUMERO (2 dígitos) desde 01-99:$'
    msj7 db 0Ah, 0Dh,'INGRESA OTRO NUMERO (2 dígitos) desde 01-99:$'
